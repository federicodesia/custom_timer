...
class CustomTimer extends StatefulWidget {
  ...
  final Widget? Function(CustomTimerRemainingTime, CustomTimerState)?
      stateBuilder;
...
class _CustomTimerState extends State<CustomTimer>
  ...
  void initState() {
    ...
    _animation = IntTween(
            begin: widget.begin.inMilliseconds, end: widget.end.inMilliseconds)
  ...
  void updateAnimationController() {
    ...
    if (state == CustomTimerState.counting) {
      ...
      else if (state == CustomTimerState.reset)
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.animationBuilder != null && widget.stateBuilder != null)
      return widget.animationBuilder!(child);
    return child;
  }
}
